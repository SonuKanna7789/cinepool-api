        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsEnthusiast = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricePerSlot = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pools_Users_CreatorUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BoosterUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Boosts_Reviews_ReviewId",
                        column: x => x.ReviewId,
                        principalTable: "Reviews",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Boosts_Users_BoosterUserId",
                        column: x => x.BoosterUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Boosts_BoosterUserId",
                table: "Boosts",
                column: "BoosterUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Boosts_ReviewId",
                table: "Boosts",
                column: "ReviewId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PoolMembers_PoolId_UserId",
                table: "PoolMembers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WatchedMovies_UserId_MovieId",
                table: "WatchedMovies",
